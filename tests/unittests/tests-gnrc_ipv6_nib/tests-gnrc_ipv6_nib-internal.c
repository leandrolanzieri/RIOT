...
/*
 * Creates CONFIG_GNRC_IPV6_NIB_NUMOF persistent entries with different IP
...
/*
 * Creates CONFIG_GNRC_IPV6_NIB_NUMOF persistent entries with different
 * interface identifiers and then tries to add another.
 * Expected result: should return NULL
 */
...
/*
 * Creates CONFIG_GNRC_IPV6_NIB_NUMOF neighbor cache entries with different
 * interface identifiers and a non-garbage-collectible AR state and then tries
 * to add another.
 * Expected result: should return NULL
 */
...
/*
 * Creates CONFIG_GNRC_IPV6_NIB_DEFAULT_ROUTER_NUMOF default router list entries
 * with different IP addresses and then tries to add another.
 * Expected result: should return NULL
 */
...
/*
 * Creates CONFIG_GNRC_IPV6_NIB_DEFAULT_ROUTER_NUMOF default router list entries
 * with different interface identifiers and then tries to add another.
 * Expected result: should return NULL
 */
...
/*
 * Creates CONFIG_GNRC_IPV6_NIB_DEFAULT_ROUTER_NUMOF default router list entries
 * with different IP addresses and interface identifiers and then tries to add
 * another.
 * Expected result: should return NULL
 */
