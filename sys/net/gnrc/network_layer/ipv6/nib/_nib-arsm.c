...
#if CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_DAD && CONFIG_GNRC_IPV6_NIB_CONF_6LR
...
#endif  /* CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_DAD && CONFIG_GNRC_IPV6_NIB_CONF_6LR */
        }
#if ENABLE_DEBUG
        else {
...
#else   /* CONFIG_GNRC_IPV6_NIB_CONF_REDIRECT */
...
#if CONFIG_GNRC_IPV6_NIB_CONF_QUEUE_PKT && MODULE_GNRC_IPV6
        /* send queued packets */
        gnrc_pktqueue_t *ptr;
