 ...
 * @see     @ref CONFIG_GNRC_IPV6_NIB_CONF_6LN
 *
...
#if CONFIG_GNRC_IPV6_NIB_CONF_6LN || defined(DOXYGEN)
/**
...
#else   /* CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_P6C || defined(DOXYGEN) */
uint32_t _handle_6co(const icmpv6_hdr_t *icmpv6,
                     const sixlowpan_nd_opt_6ctx_t *sixco);
#endif  /* CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_P6C || defined(DOXYGEN) */
#else   /* CONFIG_GNRC_IPV6_NIB_CONF_6LN || defined(DOXYGEN) */
...
#endif  /* CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_P6C || defined(DOXYGEN) */
#endif  /* CONFIG_GNRC_IPV6_NIB_CONF_6LN || defined(DOXYGEN) */
