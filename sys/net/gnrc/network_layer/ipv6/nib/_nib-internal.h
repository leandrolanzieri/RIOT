...
typedef struct _nib_onl_entry {
...
#if CONFIG_GNRC_IPV6_NIB_QUEUE_PKT || defined(DOXYGEN)
    /**
     ...
     */
    ipv6_addr_t ipv6;
#if CONFIG_GNRC_IPV6_NIB_6LR || defined(DOXYGEN)
    /**
    ...
    eui64_t eui64;
#endif
#if CONFIG_GNRC_IPV6_NIB_ARSM || defined(DOXYGEN)
    /**
...
#if CONFIG_GNRC_IPV6_NIB_ROUTER || defined(DOXYGEN)
...
#ifdef CONFIG_GNRC_IPV6_NIB_ROUTER
    /**
...
#if CONFIG_GNRC_IPV6_NIB_DC || DOXYGEN
/**
...
#if CONFIG_GNRC_IPV6_NIB_ROUTER || DOXYGEN
/**
