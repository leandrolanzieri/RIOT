 ...
 *          of the NIB
 * @see     @ref CONFIG_GNRC_IPV6_NIB_CONF_ARSM
 *
 ...
 *          available when @ref CONFIG_GNRC_IPV6_NIB_CONF_ARSM is set.
 *
 ...
 *          @ref CONFIG_GNRC_IPV6_NIB_CONF_ARSM set) since it is closely related
...
#else   /* CONFIG_GNRC_IPV6_NIB_CONF_ARSM || defined(DOXYGEN) */
...
#endif  /* CONFIG_GNRC_IPV6_NIB_CONF_ARSM || defined(DOXYGEN) */
