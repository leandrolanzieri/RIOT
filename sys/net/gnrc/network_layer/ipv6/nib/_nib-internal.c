...
#if CONFIG_GNRC_IPV6_NIB_CONF_6LN || !CONFIG_GNRC_IPV6_NIB_CONF_ARSM
...
#endif /* CONFIG_GNRC_IPV6_NIB_CONF_6LN || !CONFIG_GNRC_IPV6_NIB_CONF_ARSM */
...
{
    if ((last == NULL) ||
        (((unsigned)(_dsts - last)) < CONFIG_GNRC_IPV6_NIB_OFFL_NUMOF)) {
