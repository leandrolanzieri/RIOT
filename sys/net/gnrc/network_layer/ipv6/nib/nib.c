...
#if CONFIG_GNRC_IPV6_NIB_SLAAC || CONFIG_GNRC_IPV6_NIB_6LN
...
#if CONFIG_GNRC_IPV6_NIB_MULTIHOP_DAD
        case ICMPV6_DAR:
            /* TODO */
            break;
        case ICMPV6_DAC:
...
#if CONFIG_GNRC_IPV6_NIB_MULTIHOP_P6C
