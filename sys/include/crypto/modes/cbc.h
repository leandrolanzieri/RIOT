 ...
 */
int cipher_encrypt_cbc(cipher_context_t *context, cipher_id_t cipher_id, uint8_t iv[16], const uint8_t *input,
 ...
 */
int cipher_decrypt_cbc(cipher_context_t *context, cipher_id_t cipher_id, uint8_t iv[16], const uint8_t *input,
                       size_t input_len, uint8_t *output);
