...
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_6LBR
#define CONFIG_GNRC_IPV6_NIB_CONF_6LBR         (1)
#endif
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_SLAAC
#define CONFIG_GNRC_IPV6_NIB_CONF_SLAAC        (1)
#endif
...
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_6LR
#define CONFIG_GNRC_IPV6_NIB_CONF_6LR          (1)
#endif
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_SLAAC
#define CONFIG_GNRC_IPV6_NIB_CONF_SLAAC        (0)
#endif
#endif

#ifdef MODULE_GNRC_IPV6_NIB_6LN
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_6LN
#define CONFIG_GNRC_IPV6_NIB_CONF_6LN          (1)
#endif
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_SLAAC
#define CONFIG_GNRC_IPV6_NIB_CONF_SLAAC        (0)
#endif
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_QUEUE_PKT
#define CONFIG_GNRC_IPV6_NIB_CONF_QUEUE_PKT    (0)
#endif
#if !CONFIG_GNRC_IPV6_NIB_CONF_6LR
# ifndef CONFIG_GNRC_IPV6_NIB_CONF_ARSM
# define CONFIG_GNRC_IPV6_NIB_CONF_ARSM        (0)
# endif
# ifndef CONFIG_GNRC_IPV6_NIB_NUMOF
...
#define CONFIG_GNRC_IPV6_NIB_CONF_ROUTER       (1)
#endif

#ifdef MODULE_GNRC_IPV6_NIB_DNS
#define CONFIG_GNRC_IPV6_NIB_CONF_DNS          (1)
#endif
 ...
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_6LBR
#define CONFIG_GNRC_IPV6_NIB_CONF_6LBR         (0)
#endif
...
#define CONFIG_GNRC_IPV6_NIB_CONF_6LR          (1)
#else
#define CONFIG_GNRC_IPV6_NIB_CONF_6LR          (0)
#endif
#endif
...
#define CONFIG_GNRC_IPV6_NIB_CONF_6LN          (1)
#else
#define CONFIG_GNRC_IPV6_NIB_CONF_6LN          (0)
#endif
#endif
 ...
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_ROUTER
#if CONFIG_GNRC_IPV6_NIB_CONF_6LR
#define CONFIG_GNRC_IPV6_NIB_CONF_ROUTER       (1)
#else
#define CONFIG_GNRC_IPV6_NIB_CONF_ROUTER       (0)
#endif
#endif
 ...
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_ADV_ROUTER
#if CONFIG_GNRC_IPV6_NIB_CONF_ROUTER && \
    (!CONFIG_GNRC_IPV6_NIB_CONF_6LR || CONFIG_GNRC_IPV6_NIB_CONF_6LBR)
#define CONFIG_GNRC_IPV6_NIB_CONF_ADV_ROUTER   (1)
#else
#define CONFIG_GNRC_IPV6_NIB_CONF_ADV_ROUTER   (0)
#endif
#endif
 ...
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_ARSM
#define CONFIG_GNRC_IPV6_NIB_CONF_ARSM         (1)
#endif
...
#define CONFIG_GNRC_IPV6_NIB_CONF_QUEUE_PKT    (0)
#else
#define CONFIG_GNRC_IPV6_NIB_CONF_QUEUE_PKT    (1)
#endif
#endif
 ...
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_REDIRECT
#define CONFIG_GNRC_IPV6_NIB_CONF_REDIRECT     (0)
#endif

/**
 * @brief   (de-)activate destination cache
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_DC
#if CONFIG_GNRC_IPV6_NIB_CONF_REDIRECT
#define CONFIG_GNRC_IPV6_NIB_CONF_DC           (1)
#else
#define CONFIG_GNRC_IPV6_NIB_CONF_DC           (0)
#endif
#endif
 ...
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_DNS
#define CONFIG_GNRC_IPV6_NIB_CONF_DNS          (0)
#endif
 ...
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_P6C
#if CONFIG_GNRC_IPV6_NIB_CONF_6LR
#define CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_P6C (1)
#else
#define CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_P6C (0)
#endif
#endif
 ...
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_DAD
#define CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_DAD (0)
#endif
/** @} */
 ...
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_REACH_TIME_RESET
#define CONFIG_GNRC_IPV6_NIB_CONF_REACH_TIME_RESET (7200000U)
#endif
 ...
 */
#ifndef CONFIG_GNRC_IPV6_NIB_CONF_NO_RTR_SOL
#define CONFIG_GNRC_IPV6_NIB_CONF_NO_RTR_SOL       (0)
#endif
...
#if CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_P6C || defined(DOXYGEN)
/**
