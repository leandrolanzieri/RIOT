 ...
 * Router Solicitation.
 *
 * @note    Only handled with @ref CONFIG_GNRC_IPV6_NIB_CONF_ROUTER != 0
 */
 ...
 *
 * @note    Only handled with @ref CONFIG_GNRC_IPV6_NIB_CONF_ARSM != 0
 */
 ...
 *
 * @note    Only handled with @ref CONFIG_GNRC_IPV6_NIB_CONF_6LR != 0
 */
 ...
 * border router.
 *
 * @note    Only handled with @ref CONFIG_GNRC_IPV6_NIB_CONF_MULTIHOP_P6C != 0
 */
 ...
 *
 * @note    Only handled with @ref CONFIG_GNRC_IPV6_NIB_CONF_6LN != 0
 */
 ...
 *
 * @note    Only handled with @ref CONFIG_GNRC_IPV6_NIB_CONF_SLAAC != 0
 */
 ...
 *
 * @note    Only handled with @ref CONFIG_GNRC_IPV6_NIB_CONF_DNS != 0
 */
