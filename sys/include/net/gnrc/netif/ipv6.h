...
typedef struct {
...
#if CONFIG_GNRC_IPV6_NIB_CONF_6LN || CONFIG_GNRC_IPV6_NIB_CONF_SLAAC || DOXYGEN
    /**
     ...
     *          @ref CONFIG_GNRC_IPV6_NIB_CONF_6LN != 0 or
     *          @ref CONFIG_GNRC_IPV6_NIB_CONF_SLAAC != 0
