...
#if ENABLE_DEBUG
#   define PTHREAD_REAPER_STACKSIZE CONFIG_THREAD_STACKSIZE_MAIN
#   define PTHREAD_STACKSIZE CONFIG_THREAD_STACKSIZE_MAIN
#else
#   define PTHREAD_REAPER_STACKSIZE CONFIG_THREAD_STACKSIZE_DEFAULT
#   define PTHREAD_STACKSIZE CONFIG_THREAD_STACKSIZE_DEFAULT
#endif
