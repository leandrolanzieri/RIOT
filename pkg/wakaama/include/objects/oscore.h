...
/**
 * @brief Find the OSCORE object instance by recipient ID.
 *
 * @param[in] object                        OSCORE object handle. Must not be NULL.
 * @param[in] recipient_id                     Buffer containing the recipient ID. Must not be NULL.
 * @param[in] recipient_id_len                 Length of @p recipient_id
 *
 * @return Instance ID with the matching recipient ID.
 * @retval -1 if the instance is not found
 */
