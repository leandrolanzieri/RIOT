...
configure: $(KCONFIG_OUT_CONFIG) $(KCONFIG_GENERATED_AUTOCONF_HEADER_C)

KCONFIG_AUTOCONF_DEP = $(KCONFIG_GENERATED_AUTOCONF_HEADER_C).d

$(KCONFIG_OUT_CONFIG) $(KCONFIG_GENERATED_AUTOCONF_HEADER_C) &: $(KCONFIG_GENERATED_DEPENDENCIES) $(RIOT_GENCONFIG) $(MERGE_SOURCES) $(GENERATED_DIR)
	$(RIOT_GENCONFIG) \
	  --config-out=$(KCONFIG_OUT_CONFIG) \
	  --header-path $(KCONFIG_GENERATED_AUTOCONF_HEADER_C) \
	  --file-list $(KCONFIG_AUTOCONF_DEP) \
	  $(if $(KCONFIG_SYNC_DEPS),--sync-deps $(KCONFIG_SYNC_DIR)) \
	  $(KCONFIG) \
	  --config-sources $(MERGE_SOURCES)
	@echo "-> finished generating"

-include $(KCONFIG_AUTOCONF_DEP)
