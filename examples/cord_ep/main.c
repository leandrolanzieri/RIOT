...
static const coap_resource_t _resources[] = {
    { .path = "/node/info",  .methods = COAP_GET, .handler = _handler_info,
      .context = NULL },

    { .path = "/sense/hum",  .methods = COAP_GET, .handler = _handler_dummy,
      .context = NULL, .clif_params = "rt=\"humidity\"" },

    { .path = "/sense/temp", .methods = COAP_GET, .handler = _handler_dummy,
      .context = NULL, .clif_params = "rt=\"temperature\"" }
};
