...
const coap_resource_t coap_resources[] = {
    ...
    { .path = "/echo/", .methods = COAP_GET | COAP_MATCH_SUBTREE, .handler = _echo_handler, .context = NULL },
    { .path = "/riot/board", .methods = COAP_GET, .handler = _riot_board_handler, .context = NULL },
    { .path = "/riot/value", .methods = COAP_GET | COAP_PUT | COAP_POST, .handler = _riot_value_handler, .context = NULL },
    { .path = "/riot/ver", .methods = COAP_GET, .handler = _riot_block2_handler, .context = NULL },
    { .path = "/sha256", .methods = COAP_POST, .handler = _sha256_handler, .context = NULL },
};
