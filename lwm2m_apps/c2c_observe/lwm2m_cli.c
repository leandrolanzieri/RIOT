...
void lwm2m_cli_init(void)
{
    ...
    obj_list[4] = lwm2m_object_client_security_get();
    ...
    res = lwm2m_object_client_security_instance_create(obj_list[4], 0, &client_sec_args);
    ...
    res = lwm2m_object_client_instance_create(obj_list[5], 0, &client_args);
    if (res < 0) {
    ...
    res = lwm2m_object_access_control_instance_create(obj_list[7], 0, &acc_args);
    if (res < 0) {
    ...
    res = lwm2m_object_access_control_add(obj_list[7], 0, &acl_args);
    if (res < 0) {
